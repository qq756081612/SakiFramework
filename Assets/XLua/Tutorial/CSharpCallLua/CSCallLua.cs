...
public class CSCallLua : MonoBehaviour {
    ...
    void Start()
    {
        ...
        DClass d = luaenv.Global.Get<DClass>("d");//映射到有对应字段的class，by value  值拷贝！！！
        ...
        ItfD d3 = luaenv.Global.Get<ItfD>("d"); //映射到interface实例，by ref，这个要求interface加到生成列表，否则会返回null，建议用法 引用拷贝！！！
        d3.f2 = 1000;
